...
class TestVehicle(unittest.TestCase):
    ...
    @responses.activate
    def test_fuel(self):
        data = {"range": 1234, "percentRemaining": 0.43, "amountRemaining": 7}
    ...
    def test_batch(self):
        ...
        request_body = {"headers": headers, "requests": requests}
        mock_response = {
            "responses": [
                {
                    "headers": headers,
        ...
        expected = {
            "/odometer": {"headers": headers, "code": 200, "body": {"distance": 32768}},
            "/fuel": {
                "headers": headers,
                "code": 200,
                "body": {
        ...
        self.queue("POST", "batch", body=mock_response)
